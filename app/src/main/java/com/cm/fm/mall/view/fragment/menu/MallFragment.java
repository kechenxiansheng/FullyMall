 ...
 * 商城页面
 */
public class MallFragment extends BaseMVPFragment<MallPresenter> implements View.OnClickListener {
    ...
    public void search(String searchContent){
        ...
        List<ProductMsg> productMsgList = mPresenter.search(productMsgs, searchContent);
        if(productMsgList.size()!=0){
            productMsgs.clear();
            productMsgs.addAll(productMsgList);
            adapter.notifyDataSetChanged();
