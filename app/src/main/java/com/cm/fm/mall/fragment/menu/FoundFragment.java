...
public class FoundFragment extends BaseFragment implements View.OnClickListener {
    ...
    VideoView vv_video;
    ImageButton ib_play,ib_cycle;
    TextView tv_found_tip1,tv_found_tip2,tv_cur_time,tv_max_time;
    String tag = "TAG_FoundFragment";
    boolean isPlay = true;      //是否正在播放
    boolean isLoaded = false;   //是否加载完成
    ...
    public void init(View view) {
        ...
        tv_found_tip1 = view.findViewById(R.id.tv_found_tip1);
        tv_found_tip2 = view.findViewById(R.id.tv_found_tip2);
